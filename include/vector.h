...
/**
 * Creates a vector_t object (not a pointer!)
 *
 * @param double x value for the new vector
 * @param double y value for the new vector
 *
 * @return a vector with the defined values
**/
...
/**
 * This function takes a vector pointer and frees the memory allocated for it
 *
 * @param: vec which is a vector pointer whos memory we need to free
 * @return: Nothing
**/
void vec_free(vector_t *vec);

/**
 * Finds the magntiude of a vector using Pythagorean theorem
 *
 * @param: a vector obejct that we want the magnitude of
 * @return: a double that is the unsigned magntiude
**/
double vec_magnitude(vector_t v);

/**
* calculates the projection of one vector onto the other
*
* @param v1 a vector
* @param v2 another vector
* @return: a vector that is the projection of v1 onto v2
**/
